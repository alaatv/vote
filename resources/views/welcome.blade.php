            ...
            <div class="col-md-9 mx-auto">
                <div class="row">
                    <div class="col alert alert-info" role="alert">
                        ...
                        <p>چی بخونم و آلاء برگزار می کنند؛ سومین نظرسنجی بزرگ کتاب های کمک آموزشی (ویژه کنکور ۱۴۰۰)</p>
                        <p>این نظرسنجی از عید قربان تا عید غدیر برگزار می شود و کتاب هایی که در هر درس رتبه های اول و دوم را کسب کنند، با تخفیف ویژه ۲۵٪ در سایت چی بخونم به فروش می رسند.</p>
